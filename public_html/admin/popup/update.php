        ...
        <section class="content">
            ...
            <div class="board_A0_W">
                <table summary="팝업 제목, 노출 기간, 노출 여부, 팝업 위치, 팝업 크기, 팝업 내용을 등록합니다">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><label for="pop_title">팝업 제목</label></th>
                            <td><input type="text" name="pop_title" id="pop_title" class="input_type01 w_100p" value="<?=$row['pop_title']?>"></td>
                        </tr>
                        <tr>
