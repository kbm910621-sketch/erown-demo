		...
		<section class="content">
			...
			<div class="board_A0_W">
				<table summary="이벤트 게시판">
					...
					<tbody>
						<tr>
							<th scope="row">제목</th>
							<td><input type="text" name="ev_title" id="ev_title" class="input_type01 w_100p"></td>
						</tr>
						<tr>
							<th scope="row">작성자</th>
							<td><input type="text" name="ev_author" id="ev_author" class="input_type01 w_100" value="<?=$_SESSION['MName']?>" readonly></td>
						</tr>
						<tr>
							<th scope="row">내용</th>
							<td><textarea name="ev_description" id="ev_description" class="textarea_type01 w_100p" style="display:none;"></textarea></td>
						</tr>
						<tr>
							<th scope="row">섬네일</th>
							<td>
								...
								<ul class="file_Box">
									<li><input type="file" class="file_type01" name="userfile[]" id="ev_thumb" title="첨부파일 선택" /></li>
								</ul>
							</td>
						</tr>
						<tr>
			...
			$(function () {
				...
				$('#btn_submit').click(function(){
					...
					if(!chkForm('ev_thumb', '섬네일 이미지를', 'input', '1')) return;
