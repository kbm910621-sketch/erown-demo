...
$ph_title = chkXSS($_POST['ph_title']);
$ph_description = chkXSS($_POST['ph_description']);
$ph_author = $_SESSION['MName'];
...
$sql = "
INSERT INTO photo
(ph_title, ph_description, ph_author, ph_file0, ph_file1, ph_file2, ph_file3, ph_file4, ph_regdate)
VALUES (
    '$ph_title',
    '$ph_description',
    '$ph_author',
