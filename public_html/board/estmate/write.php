          ...
          <form name="frm" id="contactForm" method="post" action="process_write.php">
            ...
            <div class="cf-row anim">
              <div class="cf-field">
                ...
                <input type="text" name="in_company" id="in_company" class="cf-input" placeholder="회사명을 입력하세요">
              </div>
              <div class="cf-field">
                <label>담당자명 <span>*</span></label>
                <input type="text" name="in_name" id="in_name" class="cf-input" placeholder="담당자명을 입력하세요">
              </div>
            </div>
            ...
            <div class="cf-row anim">
              <div class="cf-field">
                ...
                <input type="text" name="in_tel" id="in_tel" class="cf-input" placeholder="010-0000-0000" maxlength="13" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'')">
              </div>
              <div class="cf-field">
                <label>이메일 <span>*</span></label>
                <input type="text" name="in_email" id="in_email" class="cf-input" placeholder="example@email.com">
              </div>
            </div>
            ...
            <div class="cf-field anim">
              ...
              <div class="cf-checks">
                <input type="checkbox" class="cf-chk" name="in_ad_type[]" id="t1" value="버스 광고"><label for="t1">버스 광고</label>
            ...
            <div class="cf-field anim">
              <label>문의 내용</label>
              <textarea name="in_memo" id="in_memo" class="cf-textarea" maxlength="200"
                placeholder="문의 내용을 자유롭게 작성해주세요. (200자 이내)"
                onkeyup="document.getElementById('memoCnt').innerHTML=this.value.length"></textarea>
              <div class="cf-count"><span id="memoCnt">0</span> / 200</div>
            </div>
            ...
            <div class="cf-btns anim">
              <input type="button" class="cf-btn-submit" id="btn_submit" value="상담 신청하기">
            </div>
        ...
        <div class="contact-info-section">
          ...
          <div class="contact-info-left">
            ...
            <div class="contact-info-item anim">
              ...
              <div class="contact-info-val call">062-381-1350</div>
            </div>
