	...
	<div id="container">
        ...
        <div class="inner">
            ...
            <section class="content">
                ...
                <input type="hidden" name="user_uid" value="<?=$_POST['id']?>">
                <!--board_A0_write-->
                <div class="board_A0_W">
                    <table summary="공지사항 목록이며 번호, 제목, 첨부파일, 작성자, 작성일을 제공하고 제목 링크를 통해 상세페이지로 이동합니다.">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">제목</th>
                                <td><input type="text" name="user_title" id="user_title" class="input_type01 w_100p" value="<?=$row['user_title']?>"></td>
                            </tr>
                            <tr>
                                <th scope="row">작성자</th>
                                <td><?=$row['user_name']?></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="rc_box">
                                        <li>
                                            <input type="checkbox" class="radio_type01" name="user_lock" id="user_lock" value="1" checked/>
                            ...
                            <tr>
                                <th scope="row">내용</th>
                                <td><textarea name="user_description" id="user_description" class="textarea_type01 w_100p" style="display:none;"><?=$row['user_description']?></textarea></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
